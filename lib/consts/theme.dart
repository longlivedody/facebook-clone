...
class AppTheme {
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    ...
    bodyLarge: _baseTextStyle.copyWith(
      ...
      fontWeight: FontWeight.w400,
      letterSpacing: 0.15,
      color: _lightOnSurface.withOpacity(0.87),
    ),
    bodyMedium: _baseTextStyle.copyWith(
      fontSize: 14.0,
      fontWeight: FontWeight.w400,
      letterSpacing: 0.25,
      color: _lightOnSurface.withOpacity(0.6),
    ),
  ...
  static final TextTheme _darkTextTheme = TextTheme(
    ...
    bodyLarge: _baseTextStyle.copyWith(
      ...
      fontWeight: FontWeight.w400,
      letterSpacing: 0.15,
      color: _darkOnSurface.withOpacity(0.87),
    ),
    bodyMedium: _baseTextStyle.copyWith(
      fontSize: 14.0,
      fontWeight: FontWeight.w400,
      letterSpacing: 0.25,
      color: _darkOnSurface.withOpacity(0.6),
    ),
    labelLarge: _baseTextStyle.copyWith(
      fontSize: 14.0,
      fontWeight: FontWeight.w500,
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
      ...
      background: _lightScafooldBackground,
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      hintStyle: _lightTextTheme.bodyMedium?.copyWith(
        color: _lightOnSurface.withOpacity(0.5),
      ),
    ...
    dividerTheme: DividerThemeData(
      color: _lightOutline.withOpacity(0.2),
      thickness: 1.0,
      space: 24.0,
    ),
  );
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      filled: true,
      fillColor: _darkSurface.withOpacity(0.1),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.0),
      ...
      hintStyle: _darkTextTheme.bodyMedium?.copyWith(
        color: _darkOnSurface.withOpacity(0.5),
      ),
      contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
    ...
    dividerTheme: DividerThemeData(
      color: _darkOutline.withOpacity(0.2),
      thickness: 1.0,
      space: 24.0,
    ),
  );
